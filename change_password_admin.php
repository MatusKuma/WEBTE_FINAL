...
<div class="container mt-3">
    ...
    <form id="myForm" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" class="needs-validation">
        ...
        <div class="mb-3">
            ...
            <input type="password" class="form-control" id="new_password" name="new_password" required pattern="^.{5,100}$" oninput="validateInput('Please enter new Password!', 'min-5, max-100', 'new_password', 'error-newPassword')">
            <div class="invalid-feedback">
                Password must be 5-100 characters long.
            </div>
        ...
        <div class="mb-3">
            ...
            <p id="message" ><?php if (isset($error_message) && !empty($error_message)) { echo $error_message; } ?></p>
        </div>

        <div class="mb-3">
            <button type="submit" class="btn" id="submit_btn" disabled>Change Password</button>
        </div>
    </form>
</div>
