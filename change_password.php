...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($valid) {
        ...
        exit;
        //echo "Your password has been changed successfully."; //toaster by bolo treba
    }
...
<div class="navigation_bar">
    ...
    <form id="myForm" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
        ...
        <div>
            ...
            <p id="message" style="color: red"><?php if(isset($error_message) && !empty($error_message)){echo $error_message;} ?></p>
        </div>
        <div>
