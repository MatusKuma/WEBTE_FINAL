...
-- Čas generovania: Št 16.Máj 2024, 17:57
...
--
-- Sťahujem dáta pre tabuľku `answers_open`
--

INSERT INTO `answers_open` (`id`, `question_id`, `timestamp`, `answer`, `user_id`) VALUES
(3, 9, '2024-05-15 09:02:44', 'Cierna', 19),
(4, 20, '2024-05-15 15:16:10', 'dsadsad', 19),
(5, 25, '2024-05-16 10:47:05', 'dsadsad', 19),
(6, 30, '2024-05-16 11:36:34', 'odpvoed', 29),
(7, 31, '2024-05-16 11:37:04', 'moja odpoved', 29),
(8, 32, '2024-05-16 11:40:01', 'moja odpoved', 29);
...
--
-- Sťahujem dáta pre tabuľku `answers_options`
--

INSERT INTO `answers_options` (`id`, `question_id`, `timestamp`, `answer`, `user_id`) VALUES
(5, 5, '2024-05-15 15:52:25', '1', 19);
...
--
-- Sťahujem dáta pre tabuľku `questions_open`
--

INSERT INTO `questions_open` (`id`, `creator_id`, `timestamp`, `isActive`, `title`, `subject`, `code`, `type`) VALUES
(9, 19, '2024-05-15 09:02:12', 1, 'Aka je tvoja naj farba?', 'farba', 'vGiTN', 'list'),
(30, 29, '2024-05-16 11:36:28', 1, 'testttt', 'testt', 'NjqX0', 'wordcloud'),
(31, 29, '2024-05-16 11:36:57', 0, 'testttttt', 'dsadsadsa', 'Tedmm', 'list'),
(32, 29, '2024-05-16 11:39:54', 1, 'word cloud', 'cloud test', 'wnsFb', 'wordcloud');
...
--
-- Sťahujem dáta pre tabuľku `questions_options`
--

INSERT INTO `questions_options` (`id`, `title`, `correct_answer`, `option_1`, `option_2`, `option_3`, `option_4`, `subject`, `timestamp`, `creator_id`, `isActive`, `code`) VALUES
(4, 'otazka', '1', 'odpoved1', 'odpoved2', '', '', 'test', '2024-05-14 20:52:28', 1, 1, 'G7397'),
(5, 'Ako sa dnes mas', '1', 'dobre', 'zle', 'neviem', 'dsada', 'nalada', '2024-05-15 12:56:23', 19, 1, 'e32or'),
(7, 'Testujem qr kod s otazkami', '2', 'asnwer 1', 'answer 2', 'answer 3', 'answer 4', 'test', '2024-05-16 10:49:02', 19, 1, 'gVsxd');
