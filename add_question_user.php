...
<body>
    ...
    <h2 class="mb-3 text-center">Add Question</h2>
        <div class="form-group row">
            ...
            <div class="col-sm-12">
                ...
                <label for="option2">Otvorená otázka</label>
            </div>
        </div>
        <br>
        <div id="eval_type" class="form-group <?php if (!isset($_POST['option']) || $_POST['option'] === 'option1') echo 'hidden'; ?>">
            <label for="eval_type_select">Evaluation Type:</label>
            <select name="eval_type_select" id="eval_type_select" class="form-control">
        ...
        <div class="form-group">
            ...
            <input type="text" id="subject" name="subject" class="form-control" required minlength="3" maxlength="50">
        </div>
        ...
        <br>
        <div id="error-message" class="text-center"><?php echo $error; ?></div>
    </form>
    
    <?php if (isset($code) && isset($dataUri)) : ?>
        <div class="qr-code-block mt-3 text-center">
            <label for="code">CODE:</label>
            <input type="text" id="code" class="form-control" value="<?php echo $code; ?>" readonly>
            <img src="<?php echo $dataUri; ?>" alt="QR Code" class="img-fluid">
        </div>
    <?php endif; ?>
</div>
